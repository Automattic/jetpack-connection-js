...
## [1.4.33-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Changed
- Connection: Add separate use-connection export.
...
[1.4.33-alpha]: https://github.com/Automattic/jetpack-connection-js/compare/v1.4.32...v1.4.33-alpha
